...
import static com.api.config.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    private static final String BASE_SERVICE = "com.api.core.Service";
...
//        genController("user_info",null);
    ...
    public static void genModelAndMapper(String tableName, String modelName,boolean isMapper) {
        ...
        sqlMapGeneratorConfiguration.setTargetPackage(MODEL_PACKAGE+".mapper");
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            data.put("baseService", BASE_SERVICE);
            data.put("baseServiceImpl", BASE_SERVICE_IMPL);
